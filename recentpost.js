...
function recentpostanditoblog(t) {
    ...
    for (var e = 0; e < numposts; e++) {
        ...
        try {
            ...
            s = n.content.$t, a = s.indexOf("<img"), b = s.indexOf('src="', a), c = s.indexOf('"', b + 5), d = s.substr(b + 5, c - b - 5), l = -1 != a && -1 != b && -1 != c && "" != d ? d : "https://2.bp.blogspot.com/-Q6S8qhkE33I/V0VwhvhULoI/AAAAAAAAHfQ/VZkkOgl_wX4X59EP31Jpl1swFsj6-n0TQCLcB/s1600/InfoArlina.png"
        }
        var w = n.published.$t,
            f = w.substring(0, 4),
            p = w.substring(5, 7),
            g = w.substring(8, 10),
            v = new Array;
        if (v[1] = "Jan", v[2] = "Feb", v[3] = "Mar", v[4] = "Apr", v[5] = "May", v[6] = "Jun", v[7] = "Jul", v[8] = "Aug", v[9] = "Sep", v[10] = "Oct", v[11] = "Nov", v[12] = "Dec", document.write('<li class="clearfix">'), 1 == showpostthumbnails && document.write('<span class="wrapinfo"><img class="recent_thumb" src="' + l + '" width="60" height="60"/></span>'), document.write('<b><a href="' + r + '" target ="_top">' + i + "</a></b><br>"), "content" in n) var y = n.content.$t;
